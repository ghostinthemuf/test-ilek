class PagesController < ApplicationController
  def upload
    ...
    parsing if File.exist?('public/uploads/uploaded_data')
  ...
  def parsing
    ...
    enedis_data.root.xpath('Corps_de_fichier_par_PDL').each do |client|
      ...
      client_data['Consommation'] = client.xpath('Situation_Contrat/Compteur/Periode/Donnees_Cadran/Consommation_Cadran').text
